...
<View style={{flexDirection: 'row', marginHorizontal: 20, marginTop: 40}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('GinjalPengenalan')}>
            <ImageBackground style={styles.gambar} 
                  source={require('../images/PengenalanPenyakit.png')}>    
            </ImageBackground>      
        </TouchableOpacity>
        
        <TouchableOpacity onPress={()=>navigation.navigate('GinjalPerawatan')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('GinjalDukungan')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('GinjalBudaya')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('GinjalFaskes')}>
            <ImageBackground style={styles.gambar} 
