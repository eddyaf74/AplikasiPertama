...
<View style={{flexDirection: 'row', marginHorizontal: 20, marginTop: 40}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('TbPengenalan')}>
            <ImageBackground style={styles.gambar} 
                  source={require('../images/PengenalanPenyakit.png')}>    
            </ImageBackground>      
        </TouchableOpacity>
        
        <TouchableOpacity onPress={()=>navigation.navigate('TbPerawatan')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('TbDukungan')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('TbBudaya')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('TbFaskes')}>
            <ImageBackground style={styles.gambar} 
