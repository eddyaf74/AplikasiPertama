...
const tulisan1 = "Dukungan yang diberikan pada pasien membuat pasien akan menjadi lebih percaya diri dalam melaksanakan pengobatan.";
const judul2 ="";
const tulisan2 = "";
const judul3="";
const tulisan3 = "";
...
export default JantungDukungan
