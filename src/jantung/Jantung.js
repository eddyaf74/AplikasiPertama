...
<View style={{flexDirection: 'row', marginHorizontal: 20, marginTop: 40}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('JantungPengenalan')}>
            <ImageBackground style={styles.gambar} 
                  source={require('../images/PengenalanPenyakit.png')}>    
            </ImageBackground>      
        </TouchableOpacity>
        
        <TouchableOpacity onPress={()=>navigation.navigate('JantungPerawatan')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('JantungDukungan')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('JantungBudaya')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('JantungFaskes')}>
            <ImageBackground style={styles.gambar} 
