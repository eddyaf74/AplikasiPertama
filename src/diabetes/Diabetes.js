...
<View style={{flexDirection: 'row', marginHorizontal: 20, marginTop: 40}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('DiabetesPengenalan')}>
            <ImageBackground style={styles.gambar} 
                  source={require('../images/PengenalanPenyakit.png')}>    
            </ImageBackground>      
        </TouchableOpacity>
        
        <TouchableOpacity onPress={()=>navigation.navigate('DiabetesPerawatan')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('DiabetesDukungan')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('DiabetesBudaya')}>
            <ImageBackground style={styles.gambar} 
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('DiabetesFaskes')}>
            <ImageBackground style={styles.gambar} 
